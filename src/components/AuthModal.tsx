...
export default function AuthModal({ open, onOpenChange, reason }: AuthModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-card border-border">
        <DialogHeader>
          ...
          <DialogDescription>
            {reason || (isLogin ? "Sign in to continue" : "Start creating amazing presentations")}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="modal-email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 bg-secondary/30 border-border" required />
            </div>
          </div>
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="modal-password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 bg-secondary/30 border-border" minLength={6} required />
            </div>
          </div>
